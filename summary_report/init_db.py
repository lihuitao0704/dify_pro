...
# 业务所需的全部 19 张表（顺序按模块分组，仅用于输出）
REQUIRED_TABLES: list[str] = [
    # 客户经营模块
    "intention_customer",
    "customer_convert_record",
    "customer_churn_log",
    "customer_cluster_tag",
    "daily_report_summary",
    "complaint_ai_classify",
    "student_mood_checkin",
    "student_mental_warn",
    # 员工管理模块
